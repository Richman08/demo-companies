...
import { AddCompanyPageModule } from './+main/add-company/add-company.module';
import { CompanyPagePageModule } from './+main/company-page/company-page.module';
